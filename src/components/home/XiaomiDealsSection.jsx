...
import { XiaomiDealsSectionData } from "../../data/home/XiaomiDealsSectionData";

const XiaomiDealsSection = () => {
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-4 md:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {XiaomiDealsSectionData.map((item) => (
          <div
            key={item.id}
...
export default XiaomiDealsSection;
