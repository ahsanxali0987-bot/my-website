...
const RelatedCategoriesBar = () => {
  const RelatedCategoriesBarData = [
    {
      p: "Mobiles",
    },
    {
  ...
  return (
    <div className="bg-white my-16 px-4 sm:px-4 md:px-6 lg:px-0 overflow-x-hidden">
      <div className="w-[1195px] mx-auto flex gap-7 items-center h-20">
        <p className="text-[#14a5ff] text-[12px] font-[500]">
          You Might Also Like
        </p>
        {RelatedCategoriesBarData.map((item, index) => {
          return (
...
export default RelatedCategoriesBar;
